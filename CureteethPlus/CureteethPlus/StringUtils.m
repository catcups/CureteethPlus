...
+ (NSString *)getCurrentSpTimeOfYear {
    NSDate *datenow = [NSDate date];
    NSString *current= [NSString stringWithFormat:@"%ld", (long)[datenow timeIntervalSince1970]];
    NSTimeInterval t = [current doubleValue];
    NSDate *confromTimesp = [NSDate dateWithTimeIntervalSince1970:t];
    NSDateFormatter* formatter = [[NSDateFormatter alloc] init];
...
+ (NSString *)getCurrentSpTimeOfMonth{
    NSDate *datenow = [NSDate date];
    NSString *current= [NSString stringWithFormat:@"%ld", (long)[datenow timeIntervalSince1970]];
    NSTimeInterval t = [current doubleValue];
    NSDate *confromTimesp = [NSDate dateWithTimeIntervalSince1970:t];
